"use strict"
{
    ...
    function colorCookie() {
        if (getCookie("Color") !== "") {
            ...
            document.body.setAttribute("style", "background-color: " + getCookie("Color"));
        } else {
            ...
            inputColor.addEventListener("change", (ev) => {
                ...
                document.body.setAttribute("style", "background-color: " + inputColor.value);
                ...
                setCookie("Color", inputColor.value, 7);
            });
